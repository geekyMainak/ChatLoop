...
export const sendOTP = async (email, otp) => {
    try {
        // Create a transporter using Brevo's SMTP on port 2525 (unblocked by Render)
        ...
        // Setup email data
        const mailOptions = {
            from: `"ChatLoop Support" <modakmainak19@gmail.com>`, // Use the email you verified on Brevo
            to: email,
